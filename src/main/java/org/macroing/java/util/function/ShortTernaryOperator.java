 ...
 * <p>
 * This is a functional interface whose functional method is {@link #applyAsShort(short, short, short)}.
 * 
 * @since 1.0.0
...
public interface ShortTernaryOperator {
	 ...
	 */
	short applyAsShort(final short left, final short middle, final short right);
}