 ...
 * <p>
 * This is a functional interface whose functional method is {@link #applyAsChar(char, char, char)}.
 * 
 * @since 1.0.0
...
public interface CharTernaryOperator {
	 ...
	 */
	char applyAsChar(final char left, final char middle, final char right);
}