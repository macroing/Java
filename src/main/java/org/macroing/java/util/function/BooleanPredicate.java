...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code boolean}-valued argument.
 * <p>
 * This is the {@code boolean}-consuming primitive type specialization of {@code Predicate}.
 * <p>
