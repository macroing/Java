...
/**
 * Represents an operation upon three {@code float}-valued operands and producing a {@code float}-valued result.
 * <p>
...
public interface FloatTernaryOperator {
	 ...
	 */
	float applyAsFloat(final float left, final float middle, final float right);
}